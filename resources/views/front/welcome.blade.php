...
@section('content')
    ...
    <section class="news section">
        <div class="container mb-4">
            ...
            <div class="row">
                ...
                <input type="search" id="search-event" class="form-control" placeholder="Search Upcoming Events">
    ...
    <section class="section speakers bg-speaker overlay-lighter mb-2">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="speaker-item">
                            <div class="image">
                                ...
                                <div class="socials">
                                    <ul class="list-inline">
                                        ...
                                        <li class="text-white">{{ $organizer?->organization?->name }}</li>
                            ...
                            <div class="content text-center">
                                <h5><a href="single-speaker.html">{{ $organizer?->organization?->name }}</a></h5>
                                <p>{{ $organizer?->organization?->department }}</p>
                            </div>
                        </div>
                    </div>
                @empty
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-6 align-self-center">
                    <div class="content-block">
                        <h2>About The <span class="alternate">EventHEI</span></h2>
                        <div class="description-one">
                            <p>
                                EventHEI is an event management platform for organizing and promoting events conducted by organizations and Higher Educational Institutions.
                            </p>
                        </div>
...
@push('styles')
    <style>
        .bg-banner-one {
            background: url( {{ asset('assets/front/homepage-one-banner.png') }} ) no-repeat !important;
        }
    </style>
@endpush
